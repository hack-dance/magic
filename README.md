...
[![Twitter Follow](https://img.shields.io/badge/ORIGINAL%20POST-000000.svg?style=flat-square&labelColor=000000)](https://hack.dance/thoughts/magic)
...
[ _(Code at the bottom)_ ](#a-basic-implementation)
...
Using Instructor (for structured output and partial json streaming) and OpenAI we define the scope of what an agent is.  The oai import is a pre-configured OpenAI client, and the client variable is an instance of the Instructor client, which will be used to create agent instances.
...
**Creating an agent**
Here we define our core orchestration agent for the system, as well as defining the actions available for that agent. The z import from the zod library is used to define the schema for the agent's actions and responses, ensuring type safety and validation.
